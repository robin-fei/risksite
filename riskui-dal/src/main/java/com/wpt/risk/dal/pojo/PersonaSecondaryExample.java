...
public class PersonaSecondaryExample {
    ...
    public PersonaSecondaryExample() {
    ...
    public static class Criteria extends GeneratedCriteria {
        private PersonaSecondaryExample example;

        protected Criteria(PersonaSecondaryExample example) {
            super();
            this.example = example;
        }

        public PersonaSecondaryExample example() {
            return this.example;
        }
    }
