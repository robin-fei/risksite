...
public class CustomCategoryExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private CustomCategoryExample example;

        protected Criteria(CustomCategoryExample example) {
            super();
            this.example = example;
        }

        public CustomCategoryExample example() {
            return this.example;
        }
    }
