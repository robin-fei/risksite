...
public class PersonaCategoryExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private PersonaCategoryExample example;

        protected Criteria(PersonaCategoryExample example) {
            super();
            this.example = example;
        }

        public PersonaCategoryExample example() {
            return this.example;
        }
    }
